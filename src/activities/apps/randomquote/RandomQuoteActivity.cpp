...
constexpr Line kLines[] = {
    {"生活不可能像你想象的那么好，但也不会像你想象的那么糟。", "《童年》"},
    {"世界上只有一种真正的英雄主义，那就是在认清生活真相后依然热爱生活。", "《名人传》"},
    {"满纸荒唐言，一把辛酸泪。都云作者痴，谁解其中味？", "《红楼梦》"},
    {"你把我养大，就是要让我学会，把思念埋得比海还深。", "《边城》"},
    {"我们一路奋战，不是为了改变世界，而是为了不让世界改变我们。", "《熔炉》"},
    {"人要有翻篇的勇气，也要有等待的耐心。", "《追风筝的人》"},
    {"凡事先问自己，是否值得；再问天地，是否宽厚。", "《边城》"},
    {"生活不止眼前的苟且，还有诗和远方的田野。", "《生活不止眼前的苟且》"},
    {"一个人可以被毁灭，但不能被打败。", "《老人与海》"},
    {"所有的相遇都是久别重逢。", "《一代宗师》"},
    {"那一瞬间，所有的灯都亮了起来。", "《百年孤独》"},
    {"往前走，别回头，所有的美好都在路上。", "《活着》"},
};
